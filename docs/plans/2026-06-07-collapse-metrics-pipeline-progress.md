...
Last updated: 2026-06-07T21:35:00

| # | Status | Task | Commit |
|---|--------|------|--------|
| 1 | ✅ done | Create `src/metrics.rs` with `run_all` and make ATR helpers pub (checkpoint: test) | deb68e3..HEAD |
| 2 | ⬜ pending | Strip `calculate_and_save` from the five metric modules | — |
| 3 | ⬜ pending | Rewire `main.rs` — delete standalone subcommands, replace `PerformAll` | — |
