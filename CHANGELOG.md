...
- **6 new backtest presets**: `vol-mid-plus` (vol ≥ 0.28), `vol-median-plus` (vol ≥ 0.32), `vol-high-only` (vol ≥ 0.50, research-only hard filter), `picks-4` / `picks-5` / `picks-6` (raised pick-count caps). Total presets: 38 → 44.
