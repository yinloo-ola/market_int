/* Ticket 15 tracer bullet: fetch /api/latest and render the Short timeframe
   rows in a basic table. Real data through every layer — fixture or a real
   pipeline run's document, whichever the result file holds.
   (Tabs / sort / filter / pagination / expansion are ticket 16.) */
...
function App() {
  const [latest] = createResource(fetchLatest);
